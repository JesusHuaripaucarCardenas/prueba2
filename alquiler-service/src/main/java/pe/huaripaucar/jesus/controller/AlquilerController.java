package pe.huaripaucar.jesus.controller;

import pe.huaripaucar.jesus.model.Alquiler;
import pe.huaripaucar.jesus.service.AlquilerService;
...
public class AlquilerController {
    ...
    @GetMapping("/{id}")
    public Mono<Alquiler> obtenerPorId(@PathVariable String id) {
    ...
    @PutMapping("/{id}")
    public Mono<Alquiler> actualizar(@PathVariable String id, @Valid @RequestBody Alquiler alquiler) {
